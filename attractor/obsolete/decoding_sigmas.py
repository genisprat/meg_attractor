...
#filenames=['/mnt/genis/Master_Project/process_data/resp_sub7_s5_block3-epo.fif.gz']
meta_all=[[],[],[]]
rlspock_all=[[],[],[]]
t_i=time.time()
...
#
print 'data loaded, start decoding, #trials', len(meta_all)
